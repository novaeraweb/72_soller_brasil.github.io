          ...
          <!-- your content here -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <hr>
                                <label for="nome">Linha da imagem: </label><strong> <?=$linha->nome;?></strong><br>
                        </div>
                        <?php } ?>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="card col-md-12" style="padding-top: 20px;">
                    <form  class="col-md-12" method="POST" enctype="multipart/form-data" action="alterar-imagens-linha.php" style="padding-bottom: 15px;">
