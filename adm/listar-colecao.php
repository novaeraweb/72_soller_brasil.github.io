                          ...
                          <tbody>
                              <?php foreach ($colecoes as $colecao){?>
                                <tr class="text-center">
                                    ...
                                    <a href="editar-imagens-colecao.php?id=<?php echo $colecao->idcolecao;?>" style="margin-top: 10px; margin-right: 10px;">
                                    ...
                                    <a href="editar-colecao.php?id=<?php echo $colecao->idcolecao;?>" class="info" style="margin-top: 10px; margin-right: 10px;">
                                      <button type="button" rel="tooltip" class="btn btn-success btn-round" data-toggle="tooltip" data-placement="top" title="Editar">
                                            <i class="material-icons">edit</i>
                                      </button>
                                    </a>
                                    
                                    <button type="button" class="btn btn-danger btn-round"  style="margin-top: 10px; margin-right: -75px;" data-toggle="modal" data-target="#modal-delete-colecao<?php echo $colecao->idcolecao;?>">
                                ...
                                <div class="modal fade" id="modal-delete-colecao<?php echo $colecao->idcolecao;?>" tabindex="-1" role="dialog" aria-labelledby="modal-delete"  aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                              <h5 class="modal-title" id="exampleModalLabel">Apagar Coleção</h5>
                                          ...
                                          <div class="modal-footer">
                                              ...
                                              <a href="delete-colecao.php?id=<?=$colecao->idcolecao;?>" class="info"><button type="button" class="btn btn-danger">APAGAR</button></a>
                                          </div>
                                        </div>
                                    </div>
                                </div>
