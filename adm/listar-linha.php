                    ...
                    <div class="nav-tabs-navigation">
                        <div class="nav-tabs-wrapper">
                            <ul class="nav nav-tabs" data-tabs="tabs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="#" data-toggle="tab">Linhas</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                          ...
                          <tbody>
                              <?php foreach ($linhas as $linha){?>
                                <tr class="text-center">
                                    ...
                                    <button type="button" class="btn btn-danger btn-round"  style="margin-top: 10px; margin-right: -75px;" data-toggle="modal" data-target="#modal-delete-linha<?php echo $linha->idlinha;?>">
                                ...
                                <div class="modal fade" id="modal-delete-linha<?php echo $linha->idlinha;?>" tabindex="-1" role="dialog" aria-labelledby="modal-delete"  aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                              <h5 class="modal-title" id="exampleModalLabel">Apagar Linha</h5>
                                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                              <span aria-hidden="true">&times;</span>
                                              </button>
                                          </div>
                                          <div class="modal-body">
                                              <p>Você tem certeza que deseja apagar esta Linha?<br>
                                              <b class="text-center">Esta ação é irreversível</b>.</p>
                                          </div>
                                          <div class="modal-footer">
                                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                              <a href="delete-linha.php?id=<?=$linha->idlinha;?>" class="info"><button type="button" class="btn btn-danger">APAGAR</button></a>
                                          </div>
                                        </div>
                                    </div>
                                </div>
