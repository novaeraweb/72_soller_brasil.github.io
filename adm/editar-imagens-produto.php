          ...
          <!-- your content here -->
            <div class="row"><?php require_once "alerta.php"?>
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                Utilize o formulário abaixo para editar a foto do produto:
                                <hr>
                                <label for="nome">Produto: </label><strong> <?=$produto->nome;?></strong><br>
                        </div>
                        <?php } ?>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="card col-md-12" style="padding-top: 20px;">
                    <form  class="col-md-12" method="POST" enctype="multipart/form-data" action="alterar-imagens-produto.php" style="padding-bottom: 15px;">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr class="text-center">
                                    <td><?php if ($produto->arquivo == Null) {  ?>
                                    <img src="arquivos/sem-imagem.png" alt="" width="100" height="100" />             
                                    <?php } else { ?>
                                    <img src="arquivos/<?=$produto->arquivo;?>" alt="" width="240"/> 
                                    <?php } ?>
                                    <br><br><br>
                                    <label for="arquivo">Selecione a nova imagem do Produto <br><strong>(400px X 400px)</strong></label>
                                    <br>
