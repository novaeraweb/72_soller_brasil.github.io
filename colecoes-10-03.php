								  ...
								  foreach ($produtos as $produto) { ?>
										<?php if ($produto->idlinha_prod == '4'){?>
											...
											<?php } ?>
												...
												<p class="mbr-content-title mbr-bold mbr-fonts-style display-7"><strong><?=$produto->nome;?>22</strong>, <?=$produto->descricao;?></p><br>
												<div class="peso">
										...
										<?php } else {?>
											<?php // Esse contador apenas permite a divisória com um hr e o título da linha de manutenção quando for == 1
												if ($count == 1) {?><br>
													...
													<h3 style="padding-top:2%;padding-bottom: 5%;">Line Maintenance</h3>
												...
												<div class="column third produto" style="height:700px;">
													...
													<p class="mbr-content-title mbr-bold mbr-fonts-style display-7"><strong><?=$produto->nome;?> 23</strong></p>
													<p><?=$produto->descricao;?></p><br>
													<div class="peso">
														<?php if ($produto->peso_unico == '') { ?>Z
															<ul>
																<li><?=$produto->peso_p_br;?> | <?=$produto->peso_p_en;?> </li>
																<li><?=$produto->peso_m_br;?> | <?=$produto->peso_m_en;?></li>
																<li><?=$produto->peso_g_br;?> | <?=$produto->peso_g_en;?></li>
