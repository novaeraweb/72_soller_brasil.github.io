...
<html lang="es">
	<head>
		...
		<title>Ser un representante  | S'ollér Brasil</title>
    ...
    <!-- Schema.org markup -->
    <meta itemprop="name" content="Ser un representante | S'ollér Brasil">
    <meta itemprop="url" content="https://www.sollerbrasil.com/es/reseller.php"/>
    ...
    <meta property="og:title" content="Ser un representante | S'ollér Brasil">
    ...
    <meta property="og:site_name" content="Ser un representante | S'ollér Brasil">
    <meta property="og:url" content="https://www.sollerbrasil.com/es/reseller.php">
	...
	<?php require_once "header.php" ?>
		<main role="main">
			...
			<div class="slogan animation" style="width:70%;font-size: 0.8em;" >
				<h2 style="color:white;">Ser un representante</h2>
