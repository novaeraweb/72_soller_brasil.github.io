...
$col_imgs = listaColecaoImgHomeBR($soller); ?>
<html lang="pt">
<head>
<meta charset="utf-8">
				...
				<div class="row" style="text-align:center;">
	                <div class="column four" style="text-align:center;margin-left:4%;">
						...
						<div class="alinha-soller">
	                    	<h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7"> 20 anos no mercado<br> de cosméticos</h4>
	                    </div>    
	                </div>
	            	<div class="column three" style="text-align:center;">
						...
						<div class="alinha-soller">
	                  		<h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">48 países alcançados<br> até 2017</h4>
	              		</div>
	                </div>
	                <div class="column four" style="text-align:center;">
	                    ...
	                    <div style="display: inline-block;">
	                    <div class="alinha-soller">
	                  		<h4 class="mbr-content-title mbr-bold mbr-fonts-style display-7">X não testamos em<br>animais</h4>
	                  	</div>
	                </div>
        		</div>
			</div>	
