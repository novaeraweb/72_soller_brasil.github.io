		...
		<div class="row-content buffer clear-after">
			<section id="top-footer">
				...
				<div class="widget column three">
					...
					<a href="reseller.php"><p class="button">Seja um revendedor</p></a>
				</div>											
				...
				<div class="widget column two">
					<h4>Idiomas</h4>
					<a href="#"> <img src="../img/icon-brazil.png"></a>
					<a href="../index.php"> <img src="../img/icon-usa.png"></a>
					<a href="../es/index.php"> <img src="../img/icon-spain.png"></a>
				</div>														
			</section><!-- top-footer -->
			<section id="bottom-footer">
				<p class="keep-left">S'ollér Brasil&copy; Beauty Matters | <?php echo date("Y") ?> | Todos os direitos reservados.</p>
				<p class="keep-right"><a href="https://www.novaeraweb.com.br" target="_blank" rel="noopener" rel="noreferrer"> Desenvolvido por NovaEraWeb</a></p>
