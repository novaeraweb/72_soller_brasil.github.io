    ...
    <meta name="generator" content="Criação de Sites, Marketing Digital, ADWords | Gálata">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" href="assets/images/fav/favicon.ico" type="image/x-icon">

    <!--Links que vieram originalmente com o MOBI -->
    ...
    <link rel="image_src" type="image/jpeg" href="assets/images/soller_shared.jpg" />

    <!-- Favico -->
    <link rel="apple-icon" sizes="57x57" href="assets/images/fav/apple-icon-57x57.png">
    <link rel="apple-icon" sizes="72x72" href="assets/images/fav/apple-icon-72x72.png">
    <link rel="apple-icon" sizes="76x76" href="assets/images/fav/apple-icon-76x76.png">
    <link rel="apple-icon" sizes="114x114" href="assets/images/fav/apple-icon-114x114.png">
    <link rel="apple-icon" sizes="120x120" href="assets/images/fav/apple-icon-120x120.png">
    <link rel="apple-icon" sizes="144x144" href="assets/images/fav/apple-icon-144x144.png">
    <link rel="apple-icon" sizes="152x152" href="assets/images/fav/apple-icon-152x152.png">
    <link rel="apple-icon" sizes="180x180" href="assets/images/fav/apple-icon-180x180.png">
    ...
    <!-- Schema.org markup -->
    <meta itemprop="name" content="S'ollér Brasil - Cosméticos para Cabelosa">
    <meta itemprop="url" content="https://www.sollerbrasil.com/"/>
    <meta itemprop="image" content="assets/images/soller_shared.jpg" >
    ...
    <meta property="og:image" content="https://www.sollerbrasil.com/assets/images/soller_shared.jpg">
    <meta property="og:image:secure_url" content="https://www.sollerbrasil.com/assets/images/soller_shared.jpg">
